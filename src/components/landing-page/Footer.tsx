        ...
        <footer className="bg-primary py-24 text-white">
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24">
                    ...
                    {/* Product Links */}
                    <div>
                        <h4 className="text-white font-normal text-lg mb-8 uppercase tracking-wider">Product</h4>
                    ...
                    {/* Company Links */}
                    <div>
                        <h4 className="text-white font-normal text-lg mb-8 uppercase tracking-wider">Company</h4>
                        <ul className="space-y-4">
                            <li>
                    ...
                    {/* Legal Links */}
                    <div>
                        <h4 className="text-white font-normal text-lg mb-8 uppercase tracking-wider">Legal</h4>
                        <ul className="space-y-4">
                            <li>
                                <Link to="/privacy" className="text-white hover:text-white transition-colors text-sm">
                                    Privacy Policy
                                </Link>
                            </li>
                            <li>
                                <Link to="/terms" className="text-white hover:text-white transition-colors text-sm">
                                    Terms of Service
                                </Link>
                            </li>
                            <li>
                                <Link to="/cookies" className="text-white hover:text-white transition-colors text-sm">
                                    Cookie Policy
                                </Link>
                            </li>
                        </ul>
