...
export const adminMessageTemplates: MessageTemplate[] = [
    ...
    { id: "t16", title: "New Activity On Your Agency (Marketer)", type: "In-app", trigger: "Agency case activity rollup", content: "[Agency Name] has new case activity. Open My Agencies for aggregate counts only." },
