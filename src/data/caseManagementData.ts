...
export const allCasesData: (CaseRecord & { caseType: "managed" | "self-handled" })[] = [
    // Managed Cases
    {
        caseId: "#367280",
...
export const severityStyles: Record<CaseRecord["severity"], string> = {
...
export const fraudTypeStyles: Record<CaseRecord["fraudType"], string> = {
