...
export const metricsData: Record<string, MetricCard[]> = {
    "All Time": [
        ...
        { title: "Recovered Earnings (Your 50%)", value: formatCurrency(totalRecoveredEarnings), period: "All time", change: "", topBarClass: "bg-emerald-500" },
    ],
    "First Half of Year": [
        ...
        { title: "Recovered Earnings (Your 50%)", value: "£9,600", period: "H1 2025", change: "", topBarClass: "bg-emerald-500" },
    ],
    "Second Half of Year": [
        ...
        { title: "Recovered Earnings (Your 50%)", value: "£21,150", period: "H2 2025", change: "", topBarClass: "bg-emerald-500" },
    ],
}
