...
export const FlagCaseModal = ({ open, onClose, onSubmit }: FlagCaseModalProps) => {
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden rounded-2xl sm:rounded-3xl">
                <div className="px-4 py-4 pr-12 sm:px-6 sm:py-6">
                    <h2 className="text-xl font-semibold text-foreground sm:text-2xl">Flag Case</h2>
                    <p className="mt-1 text-sm text-muted-foreground">
                        Flag this case for attention. Add a note explaining why it needs follow-up.
                    </p>
