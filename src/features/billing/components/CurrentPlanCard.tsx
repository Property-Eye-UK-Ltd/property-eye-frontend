            ...
            <div className="space-y-4 lg:space-y-6">
                ...
                <div className="rounded-xl border border-emerald-100 bg-emerald-50/50 px-3 py-3 lg:px-4 lg:py-4">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                            <p className="text-xs font-semibold uppercase tracking-wide text-emerald-700 mb-1 lg:text-[11px]">
                                Recovery Commission Terms
                            </p>
                            <p className="text-sm text-foreground font-medium lg:text-base">
                                50% to you · 50% to Property Eye
                            </p>
                            <p className="text-xs text-muted-foreground mt-1 lg:text-sm">
                                Applied to all confirmed commission recoveries on your behalf.
                            </p>
                        </div>
