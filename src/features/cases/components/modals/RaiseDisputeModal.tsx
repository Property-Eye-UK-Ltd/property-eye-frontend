...
export const RaiseDisputeModal = ({ open, onClose, onSubmit }: RaiseDisputeModalProps) => {
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden rounded-2xl sm:rounded-3xl">
                <div className="px-4 py-4 pr-12 sm:px-6 sm:py-6">
                    <h2 className="text-xl font-semibold text-foreground sm:text-2xl">Raise Dispute</h2>
