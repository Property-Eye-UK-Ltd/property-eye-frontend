...
import { PropertyListingInput, PropertyStatus } from "@/types/properties.types"
...
const initialFormValues: PropertyListingInput = {
    address: "",
    postcode: "",
    region: "",
    county: "",
...
export const AddPropertyModal = ({
    ...
    const [formValues, setFormValues] = useState<PropertyListingInput>(initialFormValues)
        ...
        >
            ...
            >
                <div className="shrink-0 bg-white px-4 py-4 pr-12 text-left sm:px-6 sm:py-6 sm:pr-6">
                    <h2 className="text-xl font-semibold text-foreground sm:text-2xl">Add a Property</h2>
                    <p className="mt-1 text-sm text-muted-foreground">
                        Submit a property for fraud monitoring. Fields marked with * are required.
                    </p>
                </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="22 Ashfield Road, Leicester"
