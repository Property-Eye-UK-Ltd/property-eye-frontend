...
import {
  CommissionBreakdownDatum,
  CommissionBreakdownPanel,
} from "@/features/overview/components/CommissionBreakdownPanel"
import { RepeatOffender, RepeatOffendersPanel } from "@/features/overview/components/RepeatOffendersPanel"
import {
  FraudDataPoint,
  FraudDetectionPanel,
  FraudSeriesConfig,
} from "@/features/overview/components/FraudDetectionPanel"
import { ActiveAlertsPanel, AlertRecord } from "@/features/overview/components/ActiveAlertsPanel"
...
const donutData: CommissionBreakdownDatum[] = [
...
const lineChartData: FraudDataPoint[] = [
...
const chartConfig: Record<string, FraudSeriesConfig> = {
  Critical: {
    label: "Critical",
    color: "#EF4444",
  },
